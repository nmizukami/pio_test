...
module pionfatt_mod
  ...
  !<
  public :: put_att
# 18 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  interface put_att
  ...
  !<
  public :: get_att
# 33 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  interface get_att
...
# 52 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  interface
     !> @brief Write a netCDF text attribute.
# 54 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
     integer(C_INT) function PIOc_put_att_text (ncid, varid, name, len, op) &
       ...
       character(C_char)        :: op
# 62 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
     end function PIOc_put_att_text
  end interface
# 64 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  interface
# 65 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
     integer(C_INT) function PIOc_get_att_text (ncid, varid, name, op) &
       ...
       character(C_CHAR)        :: name(*)
       character(C_char)        :: op(*)
# 72 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
     end function PIOc_get_att_text
  end interface


# 76 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  interface
# 77 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
     integer(C_INT) function PIOc_put_att_int (ncid, varid, name, xtype, len, op) &
       ...
       integer(C_SIZE_T), value :: len
       integer(C_INT)           :: op
# 86 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
     end function PIOc_put_att_int
  end interface
# 88 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  interface
# 89 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
     integer(C_INT) function PIOc_put_att_float (ncid, varid, name, xtype, len, op) &
       ...
       integer(C_SIZE_T), value :: len
       real(C_FLOAT)            :: op
# 98 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
     end function PIOc_put_att_float
  end interface
# 100 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  interface
# 101 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
     integer(C_INT) function PIOc_put_att_double (ncid, varid, name, xtype, len, op) &
       ...
       integer(C_SIZE_T), value :: len
       real(C_DOUBLE)           :: op
# 110 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
     end function PIOc_put_att_double
  end interface


# 114 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  interface
# 115 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 122 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
     end function PIOc_get_att_int
  end interface

# 125 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  interface
# 126 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 133 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
     end function PIOc_get_att_float
  end interface

# 136 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  interface
# 137 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 144 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
     end function PIOc_get_att_double
  end interface


# 148 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
contains
  ...
  !<
# 161 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 169 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 170 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 178 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 180 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 190 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 191 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  integer function put_att_id_text (ncid, varid, name, values) result(ierr)
    ...
    deallocate(cvar)
# 209 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  end function put_att_id_text

# 211 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 235 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  end function put_att_1d_id_text


# 238 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 251 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  end function put_att_1d_id_text_internal



# 255 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 265 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  ...
  !! @retval ierr @copydoc error_return
  !<
# 280 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 290 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 290 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  ...
  ! TYPE real,double,int
# 293 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 303 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 303 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  ...
  !! @retval ierr @copydoc error_return
  !<
# 318 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 327 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 329 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 338 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 338 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  ...
  !! @retval ierr @copydoc error_return
  !<
# 352 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 361 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 361 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  ...
  !<
  ! TYPE int,real,double
# 375 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 386 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 386 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  ...
  !<
  ! TYPE int,real,double
# 400 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 410 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 414 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 424 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 424 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  ...
  !! @retval ierr @copydoc error_return
  !<
# 438 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 446 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 446 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
  ...
  ! TYPE real,int,double
# 450 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
...
# 459 "/glade/scratch/mizukami/pio_test/cime/src/externals/pio2/src/flib/pionfatt_mod.F90.in"
